...
/**
 * subclass of report_grouptool to publish all testable methods!
 *
...
use report_grouptool;
use stdClass;
use coding_exception;
use dml_exception;
use required_capability_exception;
use report_grouptool\local\exception\exceedgroupqueuelimit;
use report_grouptool\local\exception\exceedgroupsize;
use report_grouptool\local\exception\exceeduserqueuelimit;
use report_grouptool\local\exception\exceeduserreglimit;
use report_grouptool\local\exception\registration;
use report_grouptool\local\exception\regpresent;
use report_grouptool\local\exception\notenoughregs;
use Exception;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class grouptool extends report_grouptool {
    /**
