...
use stdClass;
use report_grouptool_generator;
...
global $CFG;
require_once($CFG->dirroot . '/report/grouptool/locallib.php'); // Include the code to test!
...
abstract class base extends advanced_testcase {
    ...
    protected function create_instance($params=[]) {
        ...
        /** @var report_grouptool_generator $generator */
        $generator = self::getDataGenerator()->get_plugin_generator('report_grouptool');
